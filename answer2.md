...
* Write a custom message when we the monitor will alert or warn the users and print the host IP and hostname as well in the red square. Inside the green square, it's the user you want to notify.
<a title="4_5">
